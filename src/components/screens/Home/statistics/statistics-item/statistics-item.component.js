...
export class StatisticsItem extends ChildComponent {
    ...
    render() {
        ...
        $Q(this.element).addClass(styles[this.variant]).addClass('fade-in')
		$Q(this.element).find('#statistic-label').text(this.label)
		$Q(this.element).find('#statistic-value').text(this.value)
