...
/**
 * Represents the QwQuery class for working with DOM elements.
 */
class QwQuery {

    /**
     * Create a new QwQuery instance
     ...
     * @returns {QwQuery} A new QwQuery instance for the found element
     */
    find(selector) {
        const element = new QwQuery(this.element.querySelector(selector))
     ...
     * @returns {QwQuery|string} The current QwQuery instance for chaining 
	 ...
	 * @returns {QwQuery|string} The current QwQuery instance for chaining when setting text content, or the current text content when getting.
	 */
	text(textContent) {
	 ...
	 * @returns {QwQuery|string} The current QwQuery instance for chaining (if setting) or the attribute value (if getting).
	 */
...
/**
 * Create a new QwQuery instance for the given selector.
 * @param {string|HTMLElement} selector - A CSS selector string or an HTMLElement
 * @returns {QwQuery} A new QwQuery instance for the given selector.
 */
export function $Q(selector) {
    return new QwQuery(selector)
}